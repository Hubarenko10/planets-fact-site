...
import sat from '../../images/planet-saturn.svg';
import internal from '../../images/planet-saturn-internal.svg';
import geo from '../../images/geology-saturn.svg';
import {
  Btn,
  CommonInfo,
  CommonInfoList,
...
export const Saturn = () => {
  ...
  const [currentImage, setCurrentImage] = useState(sat);
